...
bool find_required_signatures() noexcept {
	...
	const short multiplayer_message_sig[] = { 0xA1, -1, -1, -1, -1, 0x83, 0xEC, 0x08, 0x83, 0xF8, 0x08, 0x7C, 0x05, 0xE8 };
	add_signature_s2(multiplayer_message_sig);

	const short on_multiplayer_chat_sig[] = { 0xE8, -1, -1, -1, -1, 0x84, 0xC0, 0x0F, 0x84, -1, -1, -1, -1, 0x8A, 0x44, 0x24, 0x10, 0x3C, 0xFF, 0x0F, 0x84, 0x05, 0x01, 0x00, 0x00 };
	add_signature_s2(on_multiplayer_chat_sig);
